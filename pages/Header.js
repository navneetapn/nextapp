...
import Heading1 from './customtags/Heading1';
...
export default function Header() {
    const text = 'This is dynamic text';
    return (
        <div className="header w-full">
            {/* <Heading1 size="3" text={text} setclass="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate" settitle="test title"/>
            <ul>
                <li>
                    <Link href="/">
                        <a>Home</a>
